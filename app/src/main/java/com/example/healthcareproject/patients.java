...
public class patients extends BaseActivity1 {
    ...
    public void loadVisitTypeData(){ //Visit type method for calling the web method.
        ...
        String url = "http://161.129.91.101:90/Telemed/ws_webrtc/Telemed.asmx/GetVisitTypes"; //A webmethod url
...
//        Volley.newRequestQueue(this).add(jsonObjectRequest);
    ...
    public void loadPurposeOfVisitData(ArrayList<Integer> visitList, int position){
        ...
        String url ="http://161.129.91.101:90/Telemed/ws_webrtc/Util.asmx/TelemedGlobalUserVisitsPurposesGet";
    ...
    public void loadCountriesData(String selectedValue){
        ...
        String url = "http://161.129.91.101:90/Telemed/ws_webrtc/Telemed.asmx/GetCountries";
